...
namespace Pegasus.Library.JwtAuthentication
{
    public sealed class ClaimsPrincipalFactory
    {
        ...
        /// set to "true" indicating that the authentication has been successful.
        /// </summary>
        ...
        public static ClaimsPrincipal CreatePrincipal(IEnumerable<Claim> claims, 
            string authenticationType = null, string roleType = null)
        {
            roleType = string.IsNullOrWhiteSpace(roleType) ? "Recipient" : roleType;
            authenticationType = string.IsNullOrWhiteSpace(authenticationType) ? "Password" : authenticationType;
